...
const es: Dictionary = {
  ...
  sources: {
    ...
    adaptedLabel: "Estructura adaptada de",
    alignedLabel: "Alineado con estándares reconocidos",
    note: "Cada curso acredita su fuente. La estructura se adapta de materiales con licencia abierta, nunca se copia.",
  },
  app: {
    nav: {
      home: "Inicio",
