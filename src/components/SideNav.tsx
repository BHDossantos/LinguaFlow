    ...
    <aside className="fixed inset-y-0 left-0 z-20 hidden w-60 flex-col gap-1 overflow-y-auto border-r border-black/5 bg-white px-3 py-5 lg:flex">
      ...
      <div className="mt-auto pt-4">
        ...
        {userName && (
          <Link
            href="/profile"
            className="mt-1 flex items-center gap-2.5 rounded-xl border border-black/5 px-3 py-2 hover:bg-black/[0.04]"
          >
            ...
            <span className="min-w-0">
              ...
              <span className="block text-[11px] text-ink-500">View profile</span>
            </span>
          </Link>
        )}
      </div>
